...
int KBC::qchoice1(int question) //randomnly produces questions
{
    ...
    case 1:
        ...
        cout << " 1.DIAMOND   2.ORANGE CITY    3.PINK CITY   4.CITY OF LAKES  " << endl;
    ...
    case 2:
        ...
        cout << " 1.MAHATMA GANDHI    2.RAJIV GANDHI    3.JWAHARLAL NEHRU    4.INDIRA GANDHI " << endl;
        cout << "Enter your choice " << endl;
        cin >> choice;
        check_ans1(question, choice);
        break;
...
int KBC::qchoice2(int question) //randomnly produces questions
{
    ...
    case 1:
        ...
        cout << " 1.STEPHEN FLAMING   2.ALAN BORDER    3.STEVE WAUGH    4.SACHIN TENDULKAR " << endl;
        cout << "Enter your choice " << endl;
        cin >> choice;
        check_ans1(question, choice);
        break;
    ...
    case 5:
        cout << "WHAT HAS BEEN E CURRENCY OF GREECE SINCE 2002 ? " << endl;
...
int KBC::qchoice5(int question) //randomnly produces questions
{
    ...
    case 3:
        cout << "HOW MANY LANGUAGES FEATURE ON THE LANGUAGE PANEL OF CONTEMPERORY RESERVE BANK OF INDIA CURRENCY NOTES ? ";
    ...
    case 4:
        cout << "WHICH SON OF KARNA SURVIVED,THE KURUKSHETRA WAR AND TOOK PART IN YUDDHISHTHIRA'S ASWAMEDHA YAGYA ? ";
